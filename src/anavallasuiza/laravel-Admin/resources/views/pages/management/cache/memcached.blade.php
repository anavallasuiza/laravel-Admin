...
<form method="post">
    ...
    <div class="box-footer clearfix">
        <div class="pull-right">
            <button type="submit" {{ empty($I->admin) ? 'disabled' : '' }} name="_action" value="cacheMemcached" class="btn btn-success">
                {{ __('Clear Memcached Cache') }}
            </button>
        </div>
    </div>
</form>
